...
* **Mô tả:** Tiếp nhận danh sách văn bằng mới từ CSDT. Hệ thống kiểm tra trùng lặp (AC3), tự động tính toán mã Salt/Hash, lưu DB trạng thái `Pending_Confirmation`, đẩy vào RabbitMQ và trả về kết quả ngay lập tức để giải phóng giao diện.
  ...
  "degrees": [
    {
      ...
      "studentCode": "STU-88291",
      "studentFullName": "Nguyen Van A",
      "studentEmail": "anguyen@student.edu.vn",
...
```json
{
  "message": "Degree issuance request has been accepted. The system has automatically generated tracking metadata for this execution block.",
  "batchId": "b6f8a84c-7c04-4c8d-8a5e-9989f6634b3e",
  "autoGeneratedBatchName": "BATCH_FIT_UIT_20260618_163000",
  "status": "Pending",
  "estimatedWaitTimeSeconds": 180,
  "checkStatusUrl": "/api/v1/institutions/degrees/batches/b6f8a84c-7c04-4c8d-8a5e-9989f6634b3e"
}
